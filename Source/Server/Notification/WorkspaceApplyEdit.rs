...
/// Handles : `workspace.applyEdit` notification: extension called `vscode.workspace.applyEdit(edit)` with a multi-file `WorkspaceEdit`. Sky's BulkEditService applies the edits against open models..
