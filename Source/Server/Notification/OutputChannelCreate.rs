//! Extension Host `outputChannel.create` notification - twin of `output.create`.
...
/// Handles : `outputChannel.create` notification: twin of `output.create`. See `OutputCreate.rs` for the duplicate-wire rationale..
