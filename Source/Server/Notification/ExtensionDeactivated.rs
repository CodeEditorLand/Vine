...
/// Handles : `ExtensionDeactivated` notification: log-only. Wind listens on
/// `cocoon:extensionActivated` for the positive half; extensions rarely
/// deactivate at runtime outside uninstall..
