...
/// Handles : → `statusBar.message` Emitted when an extension calls
/// `vscode.window.setStatusBarMessage` (one-shot text, optional auto-hide).
/// Canonical channel is `sky://statusbar/set-message`..
